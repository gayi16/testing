...
class Activity9 {
    public static void main(String[] args) {
        ...
        WebElement element= driver.findElement(By.xpath("//button[@class='ui violet button']"));
        builder.click(element).perform();
        WebElement elementH= driver.findElement(By.tagName("h1"));
        String hello=elementH.getText();
